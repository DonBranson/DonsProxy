...
public class LatencyDecorator extends ReadDelayDecorator {

	private int injectedLatency;
	
	public LatencyDecorator(IReadBytes decoratedWriter, int injectedLatency) {

		super(decoratedWriter);

		this.injectedLatency = injectedLatency;
		saveEarliestNextIO(0);
	}

	@Override
	protected void saveEarliestNextIO(int bytesRead) {
		setEarliestNextIO(System.currentTimeMillis() + injectedLatency);
	}
}
