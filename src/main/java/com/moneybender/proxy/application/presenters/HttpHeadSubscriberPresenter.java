...
import com.moneybender.proxy.subscribers.HttpHeadSubscriber;
import com.moneybender.proxy.subscribers.ISubscribeToPacketData;

public class HttpHeadSubscriberPresenter extends AbstractSubscriberPresenter {

	public HttpHeadSubscriberPresenter(ISubscriberView view) {
		setView(view);
		setNotRunning();
	}
