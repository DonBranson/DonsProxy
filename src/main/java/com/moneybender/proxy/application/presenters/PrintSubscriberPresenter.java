...
import com.moneybender.proxy.subscribers.PrintSubscriber;

public class PrintSubscriberPresenter extends AbstractSubscriberPresenter {
	
	public PrintSubscriberPresenter(ISubscriberView view) {
		setView(view);
		setNotRunning();
	}
